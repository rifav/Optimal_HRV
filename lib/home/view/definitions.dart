// ignore_for_file: use_key_in_widget_constructors, prefer_const_constructors, avoid_redundant_argument_values, lines_longer_than_80_chars
      ...
      body: Accordion(
        ...
        children: [
          AccordionSection(
            ...
            content: Text(
                'Resonance Frequency breathing rate is an ideal rate of breathing that'
          ...
          AccordionSection(
            ...
            content: Text(
                'Root Mean Square of the Successive Differences'), //, style: _contentStyle),
            contentHorizontalPadding: 20,
            contentBorderWidth: 1,
          ),
          AccordionSection(
          ...
          AccordionSection(
            ...
            leftIcon: Icon(Icons.favorite, color: Color(0XFFEC407A)),
            header:
                Text('High Frequency Power (HF and InHF)', style: _headerStyle),
            content: Text(''), //, style: _contentStyle),
            contentHorizontalPadding: 20,
            contentBorderWidth: 1,
          ),
